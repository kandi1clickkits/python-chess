...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/python-chess/releases/download/v1.0.0/python-chess.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/python-chess/raw/main/requirements.txt
SET REPO_NAME=Chess-Game.zip
SET EXTRACTED_REPO_DIR=python-chess
SET FILE_NAME=chess_gui.py
where /q python
IF ERRORLEVEL 1 (
	ECHO==========================================================================
